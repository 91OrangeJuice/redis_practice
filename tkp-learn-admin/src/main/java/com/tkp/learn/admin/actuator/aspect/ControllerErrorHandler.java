...
import com.tkp.learn.admin.actuator.handler.ExceptionHandlerFactory;
...
public class ControllerErrorHandler {
    ...
    public Object couponExceptionHandler(SystemException exception) {
        ...
        com.tkp.learn.admin.actuator.handler.ExceptionHandler exceptionHandler = exceptionHandlerFactory.getHandler(handlerName);
    ...
    public Object exceptionHandler(Exception e) {
        LOGGER.error("出现系统无法处理的异常！请联系服务人员及时处理![{}]", e.getMessage(),e);
