...
public class TagControllerTest {
    ...
    @Test
    public void getLessonListTopTags() throws Exception {
...
//        String jwt = jwtToken.generateJWT("TK00041447", IdentityEnum.SALESMAN.getCode());
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.get("/tag/getLessonListTopTags.auth").header("Authorization", jwt)
    ...
    public void getCategoryTags() throws Exception {
        String jwt = jwtToken.generateJWT("chenx", IdentityEnum.EMPLOYEE.getCode());
//        String jwt = jwtToken.generateJWT("TK00041447", IdentityEnum.SALESMAN.getCode());
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.get("/tag/getCategoryTags.auth").header("Authorization", jwt)
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andDo(MockMvcResultHandlers.print())
                .andReturn();
