...
import com.tkp.learn.web.actuator.handler.ExceptionHandlerFactory;
...
public class ControllerErrorHandler {
    ...
    public Object couponExceptionHandler(SystemException exception) {
        ...
        com.tkp.learn.web.actuator.handler.ExceptionHandler exceptionHandler = exceptionHandlerFactory.getHandler(handlerName);
